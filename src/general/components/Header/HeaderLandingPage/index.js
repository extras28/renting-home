                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <ul className="navbar-nav  m-0">
                            <li className="nav-item">
                                <a className="nav-link font-weight-bolder HeaderLandingPage_item ms-2" aria-current="page" href="#">Rent</a>
                            </li>
                            <li className="nav-item">
                                <a className="nav-link font-weight-bolder HeaderLandingPage_item ms-2" href="#">Buy</a>
                            </li>
                            <li className="nav-item">
                                <a className="nav-link font-weight-bolder HeaderLandingPage_item ms-2" href="#">Sell</a>
                            </li>                         
                                <Dropdown>
                        ...
                        <div className="w-100 float-end" >
                            ...
                            <button style={{backgroundColor: '#7065f0' }} className='float-end btn btn-primary '>Sign up</button>
                            <button style={{color:'#7065f0',border: '2px solid #F9FAFB', borderRadius: '8px', backgroundColor: '#edecfb' }} className='HeaderLandingPage_left me-2 btn font-weight-bolder'>Login</button>
                        </div>
                    </div>
