...
BaseTextField.defaultProps = {
    ...
    additionLabelClassName: 'font-weight-bold',
    additionalInputClassName: '',
    autoComplete: 'on',
    labelStyle: {color: '#000929'},
    require: false,
    onBlur: null,
};
...
function BaseTextField(props) {
    // MARK: --- Params ---
    const { name, fieldProps, fieldHelper, fieldMeta, type, label, placeholder, disabled, text, className, spellCheck, additionLabelClassName, additionalInputClassName, autoComplete, labelStyle, require, onBlur } = props;
    ...
    return (
        <div className='BaseTextField'>
            <div className={className}>
                ...
                <div className={`BaseTextField_Group rounded input-group ${!disabled && ''}  d-flex flex-row  justify-content-between ${disabled && 'BaseTextField_Disabled'}`}>
                    <input
